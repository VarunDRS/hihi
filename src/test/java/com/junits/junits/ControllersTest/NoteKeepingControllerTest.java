package com.junits.junits.ControllersTest;

import com.junits.junits.Contollers.NoteKeepingController;
...
public class NoteKeepingControllerTest {
    ...
    void testGetNote() {
        ...
        ResponseEntity<GetNoteResponse> response = noteKeepingController.getNote(id);
