package com.junits.junits.DaoTest;
...
public class NoteKeepingDaoTest {
    ...
    private AddNoteRequest addNoteRequests;
    ...
    void setup() {
        ...
        addNoteRequests = new AddNoteRequest();
    ...
    void testGetNote() {
        ...
        GetNoteResponse response = noteKeepingDao.getNote(1);
